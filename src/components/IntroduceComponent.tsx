      ...
      <IntroduceBox>
        ...
        <ContentBox>
          <TestDiv ref={introduceRef}>
            ...
            <ContentDiv>
              Q : 무엇을 하는 사이트인가요??
              <br />▹ 여러분의 포트폴리오를 좀 더 손쉽게 작성하도록{" "}
              <mark>양식을 제공</mark>해줍니다!
              <br />▹ 여러 분야의 포트폴리오가 궁금하지 않나요??{" "}
              <mark>서로 공유</mark>해보세요!
              <br />▹ 다른 사람의 <mark>포트폴리오를 팔로우</mark>할수 있어요!
              <br />▹ 내 블로그에 다양한 <mark>게시글들을 작성</mark>하고 서로{" "}
              <mark>댓글</mark>을 남길수 있어요!
            </ContentDiv>
          </TestDiv>
          <TestDiv ref={tipsRef}>
            <IntroduceTitleDiv>
          ...
          <TestDiv ref={snsRef}>
            ...
            <ContentDiv>
              ...
              합니다.
              <br /> 또한 <mark>기술블로그</mark> 같은 것도 제출하면 좋습니다.
            </ContentDiv>
          </TestDiv>
          <TestDiv ref={educationRef}>
            ...
            <ContentDiv>
              ▹ 학교, 전공, 입학/졸업 시기 정도로만 간략하게 쓴다. 학점은 필요
              없다.
              <br />
              ▹ 지원하는 포지션과 관련 있는 논문이나 프로젝트가 있다면 한두 줄
              추가해도 좋다.
              <br />▹ 정규 교육이나 대학 교육뿐만 아니라 지원한 포지션과
              관련하여 수료한 프로그램, 부트캠프 등을 적어도 좋다.
            </ContentDiv>
          </TestDiv>
          ...
          <TestDiv ref={languageRef}>
            ...
            <ContentDiv>
              ▹ 어학 수준이나 어학 자격증, 공인 시험 점수를 입력하면 됩니다.
              외국어 회화 수준은{" "}
              <mark>비즈니스 레벨, 네이티브 등으로 표현</mark>하는 것이 좋다.
            </ContentDiv>
          </TestDiv>
          <TestDiv ref={careerRef}>
            ...
            <ContentDiv>
              ▹ 설명 부분에 가능하면{" "}
              <mark>책임보다는 성취에 초점을 맞추어</mark> 입력합니다. 성취에
              초점을 맞추면 다른 후보자들보다 더 돋보이게 됩니다.
              <br />▹ 성과를 나열할 때 <mark>수량을 지정</mark>합니다. “매출이
              사상 최고치로 증가했습니다.” 대신 “소프트웨어 데모 프로세스를
              변경하여 <mark>2021년 매출이 20% 증가</mark>했습니다.”라고
              표현합니다.
            </ContentDiv>
          </TestDiv>
          <TestDiv ref={introMyselfRef}>
            ...
            <ContentDiv>
              ▹ 가장 자신 있는{" "}
              <mark>기술 스택과 경험이 포함된 키워드로 작성</mark>합니다. 어떤
              전문 기술을 가졌는지, 어떤 업무에 특화되어 있는지, 한 문장으로
              명확하게 보여주는 것이 좋습니다.
              <br />▹ 특히 <mark>채용 담당자의 니즈를 분석</mark>해서 그것에
              맞춰 작성하는 것이 가장 효과적입니다.
            </ContentDiv>
          </TestDiv>
          <TestDiv ref={projectRef}>
            ...
            <ContentDiv>
              ▹ <mark>가장 중요한 부분</mark>이다. 지원하는 포지션이 필요로 하는
              역량을 그간의 경험을 통해 갖추었음을 증명하는 곳이다.
              <br />▹ 회사에서 진행한 프로젝트뿐만 아니라 수상 경력이나 사이드
              프로젝트 등 포지션과 관련한 <mark>중요한 경험</mark>을 모두
              담는다.
              <br />▹ 만일 여러 명이 함께한 일이라면{" "}
              <mark>구체적으로 자신의 역할과 기여도</mark>를 나타낸다.
              <br />▹ 중요하지 않은 내용을 끼워 넣지 않는다. 구체적이고 명확한
              것이 중요하다. <mark>양보다는 질</mark>이 중요하다.
              <br />▹ 가능하다면{" "}
              <mark>
                프로젝트의 웹 URL, 블로그 아티클, 동영상, 사진 이미지 등을
                링크로 연결
              </mark>{" "}
              하세요. 높은 신뢰를 얻게 됩니다.
            </ContentDiv>
          ...
          <TestDiv ref={skillRef}>
            ...
            <ContentDiv>
              ▹ <mark>가장 자신 있는 기술 스택을 최상단</mark>에 보일 수 있도록
              입력하세요.
              <br />▹ <mark>많을수록 능시가 아니다.</mark> 지원한 포지션과 관련
              없는 기술, 내가 익숙하지 않거나 제대로 써본 적 없는 기술은
              제외한다.
            </ContentDiv>
          </TestDiv>
        </ContentBox>
